    ...
    <section class="informations">
        <form method="post" action="NewClient_traitement.php" onsubmit="return validate()" enctype="multipart/form-data">
            <fieldset class="box">
                ...
                <input type="email" name="mail" id="mail" placeholder="arthurlorphelin@gmail.com" size="40" required>
                <br/>
                <br/>
                <label for="pass">Password</label> :
                <input type="password" name="password" id="pass" size="40" placeholder="********" required>
                <br/>
                <br/>
